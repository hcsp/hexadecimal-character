...
public class Solution {
    ...
    public static boolean isValidHexCharacter(char ch) {
        boolean isNumber = (int) ch >= 48 && (int) ch <= 57;
        boolean isLowerWord = (int) ch >= 97 && (int) ch <= 107;
        boolean isUpperWord = (int) ch >= 65 && (int) ch <= 70;

        return isNumber || isLowerWord || isUpperWord;
    }
}
